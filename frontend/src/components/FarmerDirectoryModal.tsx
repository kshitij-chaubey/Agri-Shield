        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-sm transition-all flex items-center gap-1.5"
            >
                    ...
                    <tr key={f.id} className="hover:bg-slate-900/50 transition-colors">
                        ...
                        {editingId === f.id ? (
                          <div className="flex items-center gap-1">
                            <input
                              ...
                              className="w-32 bg-slate-900 border border-indigo-500 rounded px-2 py-0.5 text-xs text-white"
                            />
                            <button
                      ...
                      <td className="p-3 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-indigo-400 hover:text-indigo-300 border border-slate-800 text-xs font-medium"
                        >
                          Select
                        </button>
                      </td>
